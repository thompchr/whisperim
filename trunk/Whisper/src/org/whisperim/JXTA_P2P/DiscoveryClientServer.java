...
public abstract class DiscoveryClientServer implements DiscoveryListener,
    ...
    public DiscoveryClientServer(PeerGroup group,
            int adType) {
    ...
    public Enumeration getAdvertisements() {
        try {
            return discover_.getLocalAdvertisements(adType_, attribute_, value_); 
        } catch (IOException e) {
          return null;    
        }
    }
    ...
    public void groupChanged(PeerGroup group) {    
        ...
        try {
            ...
            processAdDiscovered( new AdvertisementEvent(this,
                          AdvertisementEvent.ALL_ADV_DELETED,
                          (List)null) );
   ...
   // Search through advertisements. 
    ...
    // Compares two ad
    protected abstract boolean compareAds(Advertisement ad1,
            Advertisement ad2);
