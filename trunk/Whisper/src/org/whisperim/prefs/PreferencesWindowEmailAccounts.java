...
public class PreferencesWindowEmailAccounts extends JPanel implements ActionListener {
	...
	public PreferencesWindowEmailAccounts() {
		 ...
		 * 
		 * Because of some odd alignement issues, these dimensions might vary by +/- a few pixels
		 */

		//Title Label
		sl.putConstraint(SpringLayout.NORTH, headerLbl_, 15, SpringLayout.NORTH, this);
		sl.putConstraint(SpringLayout.WEST, headerLbl_, 20, SpringLayout.WEST, this);
		...
		sl.putConstraint(SpringLayout.WEST, usernameLbl_, 30, SpringLayout.WEST, this);

		//Username Field
		sl.putConstraint(SpringLayout.NORTH, usernameField_, 40, SpringLayout.SOUTH, headerLbl_);
		...
		//Password Field
		sl.putConstraint(SpringLayout.NORTH, pwField_, 20, SpringLayout.SOUTH, usernameLbl_);
		sl.putConstraint(SpringLayout.WEST, pwField_, 0, SpringLayout.WEST, usernameField_);

		//smtp label
		sl.putConstraint(SpringLayout.NORTH, smtpLbl_, 20, SpringLayout.SOUTH, pwLbl_);
		sl.putConstraint(SpringLayout.WEST, smtpLbl_, 0, SpringLayout.WEST, pwLbl_);
		
		//smtp field
		sl.putConstraint(SpringLayout.NORTH, smtpField_, 0, SpringLayout.NORTH, smtpLbl_);
		sl.putConstraint(SpringLayout.WEST, smtpField_, 0, SpringLayout.WEST, pwField_);
		
		//pop3 label
		sl.putConstraint(SpringLayout.NORTH, pop3Lbl_, 20, SpringLayout.SOUTH, smtpLbl_);
		sl.putConstraint(SpringLayout.WEST, pop3Lbl_, 0, SpringLayout.WEST, smtpLbl_);
		
		//pop3 field
		sl.putConstraint(SpringLayout.NORTH, pop3Field_, 20, SpringLayout.SOUTH, smtpField_);
		sl.putConstraint(SpringLayout.WEST, pop3Field_, 0, SpringLayout.WEST, smtpField_);
		
		//Save Button
		sl.putConstraint(SpringLayout.NORTH, saveButton_, 40, SpringLayout.SOUTH, pop3Lbl_);
		sl.putConstraint(SpringLayout.WEST, saveButton_, 0, SpringLayout.WEST, pop3Lbl_);
		
		//Cancel Button
		sl.putConstraint(SpringLayout.NORTH, cancelButton_, 0, SpringLayout.NORTH, saveButton_);
		sl.putConstraint(SpringLayout.WEST, cancelButton_, 20, SpringLayout.EAST, saveButton_);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (ac.equalsIgnoreCase(SAVE_)){
			try {
				...
				JOptionPane.showMessageDialog(this, "Whatever you just did worked...finally.");
