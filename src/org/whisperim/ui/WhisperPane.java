...
class WhisperPane extends JTabbedPane {
	  ...
	  private int getTargetTabIndex(Point glassPt) {
	    Point tabPt = SwingUtilities.convertPoint(glassPane, glassPt, WhisperPane.this);
